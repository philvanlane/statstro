...
import Registrants2025 from './components/Registrants2025';
    ...
    <Router>
      <nav className="navbar">
        ...
        <div className="nav-links">
          ...
          <div className="route-link">
            <a className="link" href="/#/2025/registrants">Registrants</a>
          </div>
      ...
      <Routes>
          ...
          <Route path="/2025/registrants" element={<Registrants2025/>} />
        </Routes>
    </Router>
    </div>
  );
